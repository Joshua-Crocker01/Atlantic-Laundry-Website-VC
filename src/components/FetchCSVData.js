...
export default function FetchCSVData(props) {
    ...
    const fetchCSVData = () => {
    const csvUrl = 'https://docs.google.com/spreadsheets/d/1njQL2D4WVBtTdQ7xU6uTiel8PMGztNy9lWv5m69_EOo/pub?output=csv'; // Replace with your Google Sheets CSV file URL
